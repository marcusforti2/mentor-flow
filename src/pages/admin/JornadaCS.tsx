...
function MentoradoCard({ mentorado }: { mentorado: Mentorado }) {
  ...
  return (
    <div className="p-4 rounded-lg border border-white/10 bg-white/5 backdrop-blur-sm hover:bg-white/10 hover:border-primary/50 hover:shadow-[0_0_20px_rgba(212,175,55,0.15)] transition-all duration-300 cursor-pointer shadow-sm group">
