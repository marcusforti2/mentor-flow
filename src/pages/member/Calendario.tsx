...
interface CalendarEvent {
  ...
  event_time: string | null; event_type: string; meeting_url: string | null;
}

const eventTypeColors: Record<string, string> = {
  geral: "bg-blue-500", mentoria: "bg-purple-500", live: "bg-red-500",
  prazo: "bg-yellow-500", reuniao: "bg-green-500",
};
const eventTypeLabels: Record<string, string> = {
  geral: "Geral", mentoria: "Mentoria", live: "Live", prazo: "Prazo", reuniao: "Reunião",
};
...
export default function CalendarioMembro() {
  ...
  const getEventsForDate = (date: Date) => events.filter(event => isSameDay(parseISO(event.event_date), date));
