...
export default function Treinamento() {
  ...
  const handlePdfUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file && file.type === "application/pdf") {
      ...
      reader.onload = async () => {
        // For PDFs, we'll send the base64 to the edge function
            ...
            {isAnalyzing ? (
              ...
              <ScrollArea className="h-[500px] pr-4">
                <div className="space-y-6">
                  ...
                  {/* Ouro - não mude */}
                  {analysisResult.ouro_nao_mude?.length > 0 && (
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1.5">
                        {analysisResult.ouro_nao_mude.map((item, idx) => (
                  ...
                  {/* Pontos Fortes */}
                  {analysisResult.pontos_fortes?.length > 0 && (
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1.5">
                        {analysisResult.pontos_fortes.map((item, idx) => (
                  ...
                  {/* Muda Urgente */}
                  {analysisResult.muda_urgente?.length > 0 && (
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1.5">
                        {analysisResult.muda_urgente.map((item, idx) => (
                  ...
                  {/* Errou Feio */}
                  {analysisResult.errou_feio?.length > 0 && (
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1.5">
                        {analysisResult.errou_feio.map((item, idx) => (
                  ...
                  {/* Pontos Fracos */}
                  {analysisResult.pontos_fracos?.length > 0 && (
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1.5">
                        {analysisResult.pontos_fracos.map((item, idx) => (
                  ...
                  {/* Como Melhorar */}
                  {analysisResult.como_melhorar?.length > 0 && (
                    <div className="space-y-2">
                      ...
                      <ul className="space-y-1.5">
                        {analysisResult.como_melhorar.map((item, idx) => (
