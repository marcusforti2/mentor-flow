...
Deno.serve(async (req) => {
  try {
    ...
    console.log("Calendar callback received", { hasCode: !!code, hasState: !!stateParam, error });
    ...
    console.log("Calendar connected successfully for", calendarEmail);
    return htmlResponse("Google Calendar conectado com sucesso!", true);
  } catch (error) {
